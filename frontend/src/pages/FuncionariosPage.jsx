...
function FuncionariosPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Funcionarios"
        description="Cadastre os servidores ou colaboradores responsaveis pelos atendimentos."
      />
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                value={form.setorId}
                onChange={(event) =>
                  setForm((state) => ({ ...state, setorId: event.target.value }))
                }
                required
              >
            ...
            {funcionarios.length ? (
              funcionarios.map((funcionario) => (
                ...
                >
                  ...
                  <button
                    type="button"
                    className={funcionario.ativo ? "btn-warning" : "btn-primary"}
                    onClick={() => handleToggle(funcionario.id)}
                  >
